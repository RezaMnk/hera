        ...
        <div class="col-12 col-md-9">
            ...
            <div class="card d-block d-md-none">
                <div class="card-body row">
                    ...
                    <div class="col-12 mt-4">
                        <a href="{{ route('home.post', $post->slug) }}" target="_blank">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="عنوان" value="{{ old('title') ?: $post->title }}" required>
            ...
            <div class="card">
                <div class="card-body">
                    <label>متن</label>
                    <textarea id="text" name="text" @error('text') class="is-invalid" @enderror>{{ old('text') ?: $post->text }}</textarea>
        ...
        <div class="col-12 col-md-3">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <img src="{{ $post->get_image() }}" id="post-image" class="w-100 shadow-sm rounded" alt="{{ $post->title }}">
                    </div>
