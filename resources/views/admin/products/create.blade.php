            ...
            <div class="card">
                <div class="card-body row">
                    <div class="col-12 col-md-8">
                        ...
                        <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="نام محصول" value="{{ old('name') }}" required>
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="number" id="price" name="price" class="form-control @error('price') is-invalid @enderror" placeholder="قیمت محصول" value="{{ old('price') }}" required>
                ...
                <div class="card-body">
                    ...
                    @forelse($categories as $category)
                        <label class="image-radio">
                            <input type="radio" name="category" value="{{ $category->id }}" @checked(old('category') == $category->id) />
        ...
        <div class="col-12 col-md-3">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <img src="{{ asset('storage/default.png') }}" id="product-image" class="w-100 shadow-sm rounded" alt="تصویر محصول">
                    </div>
